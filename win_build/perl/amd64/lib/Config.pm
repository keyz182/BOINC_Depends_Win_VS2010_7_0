...
tie %Config, 'Config', {
    archlibexp => 'C:\Progra~1\Perl64\\lib',
    ...
    osvers => '5.2',
    path_sep => ';',
    privlibexp => 'C:\Progra~1\Perl64\\lib',
    scriptdir => 'C:\Progra~1\Perl64\\bin',
    sitearchexp => 'C:\Progra~1\Perl64\\site\\lib',
    sitelibexp => 'C:\Progra~1\Perl64\\site\\lib',
    so => 'dll',
    useithreads => 'define',
